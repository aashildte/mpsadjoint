...
def parse_cl_arguments():
    ...
    d = parser.parse_args()
    return d.from_step, d.to_step, d.step_length, d.num_iterations_iterative, d.num_iterations_combined, d.dose, d.mesh_res

from_step, to_step, step_length, num_iterations_iterative, num_iterations_combined, dose, mesh_res = parse_cl_arguments()
